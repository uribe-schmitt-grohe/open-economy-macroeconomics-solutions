...
**Equilibrium With Production in Both Sectors**
...
$$
\Rightarrow  \fbox{$
\frac{A^T(1-L^N) - r/(1+r)d_0}{A^NL^N}=\frac{A^T}{A^N}$}
$$

$\Rightarrow$ Any temporary shock that changes the desired net asset  position, $b$, will produce a permanent reallocation of labor. 

**Complete De-Industrialization**

If the net asset position is large enough, then  
...
$$
p = \frac{-r/(1+r)d_0}{A^L}
$$

$\Rightarrow$ The economy exhibits complete  de-industrialization, and the real exchange rate ceases to be determined by technological factors alone.  (Note that the economy mut be a net creditor, $d_0<0$.)