...
Need $\gamma_{11} \in (0,1)$, $\gamma_{22} > 1$, and $\gamma_{21} > 0$. Policy functions:

$$
\hat{d}_t = \gamma_{11}\hat{d}_{t-1} \quad \text{and} \quad \hat{c}_t = \frac{\gamma_{11} - \gamma_{22}}{\gamma_{21}}\hat{d}_{t-1}
$$